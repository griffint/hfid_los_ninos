...
?>
    ...
    <div class="body">Our design development page is here</div>
        ...
        <br>
        To look at our prototype, click <a href="prototype/index.html">here</a>.
        <br>
		...
		<br>
            Some design choices we made were improvements on our second paper prototype that we had not drafted because we did not consider it to be a main part of our prototype. One area of improvement was the chat feature. When we drafted our wireframes, we found that it would be useful to have a chat feature similar to Facebook's, where conversations between users would persist at the bottom of the page. When a user clicked the "Contact" button on a card, it would start a conversation and a box would show up on the bottom of the page.
            <br><br>
            <div class = "image"><img src='./imgs/wireframes/contacts.png' class='jasperimages'></div><br>
            <p class='caption'>Pop Up Chat Interaction Page</p>
            <br><br>
             We had made this design choice so that our users could always maintain a thread of communication while navigating anywhere on our site. 
			<br>
            The other area of improvement was the "Group" section. Our team knew there were some potential use cases that our interfaces was not designed for, so we wanted to make that section more polished while making our wireframes. Our "Group" section had only one page, which showed a user's "Pending Groups" and "Your Group".
            <br><br>
            <div class = "image"><img src='./imgs/wireframes/group_pending.png' class='jasperimages'></div><br>
            <p class='caption'>Groups Pending Page</p>
            <br><br>

            We decided to have several pages for the state, for cases such as when the user wants to leave a group, join a different group and etc. We had also wanted our users to be able to communicate within their group, so we added a group chat feature.
            <br><br>
            <div class = "image"><img src='./imgs/wireframes/group_chat.png' class='jasperimages'></div><br>
            <p class='caption'>Group Chat Page</p>
            <br><br>
            We felt that this added a sense of safety and security since users are encouraged to communicate on our platform, as oppposed to having to give out their personal email or other contact information.
			<br>
            We also made some changes from our second paper prototype based on learning new design principles. Our team believed that our wireframes had too much content in the front. Our team had learned that too much content could negatively impact the user experience. We wanted there to be less text, so one design decision was to remove the "Contact" option on people's cards located at the righthand side of the "Map" section.
            <br><br>
            <div class = "image"><img src='./imgs/wireframes/map_filters.png' class='jasperimages'></div><br>
            <p class='caption'>Map Page</p>
            <br><br>
            We did not think it negatively affected usability, since we did not expect our users to contact a person's card, which contains limited personal information.
...
<br>
		...
		<h3>Insights</h3>
		<br>
			<div class="image"><img class="jasperimages" src="./imgs/prototype_screenshots/large_profile.png"></div>
			<br>
			<p class='caption'>Concerns were raised about displaying so much information to somebody who is not logged in.</p>
		...
		<br>
			<div class="image"><img class="jasperimages" src="./imgs/prototype_screenshots/map.png"></div>
			<br>
			<p class='caption'>The infamous people dots</p>
<br>
            Other insights centered around the user's interaction with the interface itself. Our evaluators claimed that some of the buttons are not clear, which means that we will need to go in and overhaul some of the buttons such as replacing the people-dot representations with actual people icons. By changing our design to meet the standards of other websites, we will help make the user interaction more comfortable as they will be more used to the visual queues we provide. This standardization will include things like streamlining our profile setup into one page, as our users were confused by what we meant by basic and advanced profile, thinking they were two different types of profiles. Both our team and our evaluators noticed consistency issues in the interface, specifically things like linking profile information pop ups to people's avatars which were available on some pages but not on others. We will need to take another pass at the interface to make sure that interactions on one page of the interface work the same as other pages, and that pages are connected and linked in the ways we originally intended going into the prototype. Finally, given that a lot of the choices presented to the user were big deals such as joining a group or removing somebody from your contacts, we realized that we would need to give the user the choice to undo or confirm such choices so they would feel more secure in all of the interactions they perform.
			<br>
			<div class="image"><img class="jasperimages" src="./imgs/prototype_screenshots/filter.png"></div>
			<br>
...
<br>
		...
		<br>
			<div class="image"><img class="jasperimages" src="./imgs/prototype_screenshots/basic_profile.png"></div>
			<br>
			<div class="image"><img class="jasperimages" src="./imgs/prototype_screenshots/advanced_profile.png"></div>
			<br>
			<p class='caption'>The basic and advanced profile views that confused the users.</p>
