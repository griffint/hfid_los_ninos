...
?>
		<div class ="body-border">
			...
			<ul>
				<li>Craigslist - We are inspired its interface for finding rooms. </li>
				<li>Airbnb - We like its verification and reputation for security as well as its other features. </li>
				<li>Newegg Search - We are inspired by the use of filters and other narrowing features. </li>
				<li>Alumni Mailing List - We like the sense of trustworthiness people have with alumni. </li>
				<li>Tinder - We like the ease of using its matching interface. </li>
				<li>Facebook Groups - We like being able to view mutual friends. </li>
				<li>Zillow - We are inspired by viewing and investigating properties in a particular area. </li>
				<li>Padmapper - We like the usability for finding sublets. </li>
				<li>Coffee meets bagel - We like the idea of only one match a day and think it could apply to finding roommates.</li>
				<li>Your Home Suite - We like the emphasis on images and its purpose in finding rental homes.</li>
				<li>Eharmony - We like their user verification.</li>
				<li>OkCupid - We like their matching algorithm and its metric for how compatible two users are. </li>
				<li>LinkedIn - We like the Mutual Connections feature, which can be applicable to finding similar people. </li>
				<li>Padmapper - We would like to grab postings from other sites similar to this service.</li>
				<li>Yoroomies app - A similar roommate finding app. </li>
				<li>Physical Bulletin board of postings - A simple, easy interface for finding things all at once. </li>
				<li>Binder Full of Postings - We are inspired by viewing things one-by-one like flipping through a binder. </li>
			</ul>

			<h3>Detailed Inspiration Ideas</h3>
			<p>
				<h2>Airbnb Safety & Security- Jasper</h2>

			<img class="home" src='http://i.imgur.com/XDPwxVt.jpg'><br>

			AirBnb is a website for people to list, find and rent lodging. While our team's design emphasizes more on helping people find roommates, we would like to borrow some successful design elements used by AirBnb. We are inspired by AirBnb's rental listing service because of its popularity and reputation for safety and security. At the bare minimum, we would like our users to feel safe and secure from finding to living with their roommates. To reach this goal, we would like to borrow some safety and security design elements and also omit others that are not as relevant.<br>

			<img class="trust" src='http://i.imgur.com/Aguy1sy.png'><br>
			Trust is important in dealing with the host and room seekers. At the bottom of each AirBnb listing, a section with Trust badges of the host is displayed at the bottom of each listing. These badges are obtained by meeting criteria, such as hosting several times, receiving reviews and verifying an official ID. We like that these badges function as visual cues about hosts. A reader can skim through a listing and quickly assess information.<br>

			We would like to include similar badges for roommate seekers to ensure a sense of security. We think that it is also important for other room seekers to quickly learn about each other, such as whether they are clean or messy, or whether they are an early bird or a night owl. However, we do not want to include too many badges, which may confuse or distract the user. <br>

			<img class="about_host" src='http://i.imgur.com/bQmzdWX.png'><br>

			There is a section that focuses on the host, below the Trust section. A brief biography and picture about the host is included at the bottom of the listing. We like that the biography and image since it enables the user to capture a first impression of the host. We also like the option to contact the host on the same page and an option to view the mutual friends. This provides an extra sense of security because of the ability to connect with the host through a line of communication. However, we think the connections section can be improved because the connections section disappears if the user does not share any mutual friends. <br>

			We would like to add the option of adding a brief biography and picture in a roommate seeker's profile. This allows them to add any additional information about themselves, which can be important for others to learn more about them. We would like to show mutual friends through a similar interface. <br>

			<img class="full_host" src="http://i57.tinypic.com/20f8cvm.png"><br>

			When clicking on the full profile, we find a more complete profile of the host. We find more information on their personal background, specifically their contact information, number of friends, number of reviews, education and work. We like that there is a lot of information about the user. It provides a level of personalization to the profile, but we think there may be too much personal information displayed.<br>

			We are cautious on requiring more information than is necessary from our users. We are interested in exploring the option to make some fields of information to be mandatory, but the verified ID and About Me section be left optional.<br>

			With these features, we can provide a simple interface to help people roommates and feel confident in feeling safe and secure. <br>

			</p>
			<br>
			<p>
				<h2>Newegg Search Features - Jeff</h2>
				
			Newegg Search Narrowing lists all of the features of the device in question and lets the user select criteria ranges for each of these features as filters, allowing users to hone in on product traits that are important to them. These narrowing filters remove products that do not fit the user's specifications, meaning that the user can focus on deciding between a smaller number of products that match what they want. It is a powerful way to let users quickly sort through massive lists of products. In the example below, we are browsing monitors, and we have selected a price range, response time, and contrast ratio, which are represented both checks on the narrowing filter browser on the left, and as tags at the top of the page.<br>
			<img src='http://i.imgur.com/d1uwDwu.png'><br>
			...
			<img src='http://i.imgur.com/dkGkTYe.png'><br>
			...
			<p>
				...
				<br>
				<img src="./imgs/craigslist_listview.png">
				...
				<br>
				<img src="./imgs/craigslist_posting.png">
			</p>
		</div>
	</body>
</html>